const songClues = [
    ...
    { 
        name: 'Gethsemane',
        clues: ['greatest pain', 'love', 'hardest thing', 'greatest pain', 'gift', 'His promise', 'Jesus', 'fight was won'],
        color: '#36c9c6',
    },
    { 
    ...
    { 
        ...
        clues: ['holy place', 'sealed', 'prepare', 'house of God', 'covenant', 'love', 'beauty', 'promise', 'family is forever'],
        color: '#dbfe87 ',
    },
    { 
    ...
    { 
        ...
        clues: ['family', 'eternity', 'share my life', 'earth', 'plan', 'together', 'the Lord'],
        color: '#347fc4',
    },
]